            ...
            <div className="px-4 mx-auto sm-px-6 lg-px-8 max-w-7xl">
                <div className="grid grid-cols-2 md-col-span-3 lg-grid-cols-6 gap-y-16 gap-x-12">
                    ...
                    <div className="company">
                        ...
                        <ul className="mt-6">
                            <li>
                                <a href="/AboutUs" title="" className="flex text-base text-black transition-all duration-200 hover-text-blue-600 focus-text-blue-600"> About </a>
                            </li>
                    ...
                    <div className="col-span-2 md-col-span-1 lg-col-span-2 lg-pl-8">
                        ...
                        <form action="#" method="POST" className="mt-6">
                            <div>
                                ...
                                <input type="email" name="email" id="email" placeholder="Enter your email" className="emailbox" />
                            </div>
